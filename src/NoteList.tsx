...
import { Badge, Button, Card, Col, Form, Modal, ModalHeader, Row, Stack } from "react-bootstrap"
...
function EditTagsModal({availableTags, handleClose, show, onUpdateTag, onDeleteTag}: EditTagsProps) {
    return (
